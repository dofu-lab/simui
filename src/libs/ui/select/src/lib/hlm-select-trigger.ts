...
@Component({
	...
	template: `
		<button
			...
			<ng-content />
			<ng-icon name="lucideChevronDown" class="text-muted-foreground ms-auto text-[calc(var(--spacing)*4)]" />
		</button>
	`,
})
