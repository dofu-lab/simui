			...
			<div class="flex max-w-[1000px] flex-col items-start justify-center gap-12">
				<div>
					...
					<span class="text-primary text-lg">
						...
						unstyled and composable UI primitives that let you build your own design system or integrate seamlessly with
						utility-first CSS frameworks like Tailwind CSS. In this project, Spartan UI was used to create reusable
						components such as buttons, dialogs, menus, and forms—ensuring both accessibility and flexibility across the
						application.
					</span>
				</div>
				<div>
					...
					<span class="text-primary text-lg">
						...
						. Some component designs were directly influenced by their aesthetic and UX patterns, which helped shape the
