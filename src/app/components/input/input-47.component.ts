		...
		<div class="flex flex-col -space-y-px rounded-md shadow-xs" [formGroup]="form">
			<div class="w-full text-sm">
				<div class="relative">
					...
					<div
						class="text-muted-foreground/80 pointer-events-none absolute inset-y-0 end-0 flex items-end justify-center pe-3 pb-2 peer-disabled:opacity-50">
...
export const input47Code = `import { Component, inject } from '@angular/core';
import { FormBuilder, FormGroup, FormsModule, ReactiveFormsModule, Validators } from '@angular/forms';
import { MaskitoDirective } from '@maskito/angular';
import { MaskitoOptions } from '@maskito/core';
import { maskitoDateOptionsGenerator } from '@maskito/kit';
