				...
				<div hlmEmptyMedia>
					<div
						...
						<hlm-avatar class="size-12">
							<img src="assets/backgrounds/bg-01.jpg" alt="avatar 1" hlmAvatarImage />
							<span class="bg-[#FD005B] text-white" hlmAvatarFallback>A1</span>
						</hlm-avatar>
						<hlm-avatar class="size-12">
							<img src="assets/backgrounds/bg-02.jpg" alt="avatar 2" hlmAvatarImage />
							<span class="bg-[#FD005B] text-white" hlmAvatarFallback>A2</span>
						</hlm-avatar>
						<hlm-avatar class="size-12">
							<img src="assets/backgrounds/bg-03.jpg" alt="avatar 3" hlmAvatarImage />
