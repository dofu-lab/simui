		...
		<div class="space-y-4">
			...
			<div hlmAccordion>
				@for (item of items; track item.title) {
					<div
						hlmAccordionItem
						class="bg-background has-focus-visible:border-ring has-focus-visible:ring-ring/50 relative border border-b-0 px-4 py-1 outline-none first:rounded-t-md last:rounded-b-md last:border-b has-focus-visible:z-10 has-focus-visible:ring-[3px]">
						<button
							hlmAccordionTrigger
