...
@Component({
	...
	template: `
		<hlm-tabs tab="tab01" class="w-full">
			<hlm-tabs-list
				class="[&>button]:data-[state=active]:bg-muted text-muted-foreground/70 mx-auto flex h-fit w-full max-w-xs items-center justify-center rounded-md bg-transparent p-0.5 group-data-horizontal/tabs:h-fit [&>button]:mr-0 [&>button]:data-[state=active]:shadow-none"
