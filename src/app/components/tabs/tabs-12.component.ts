...
@Component({
	...
	template: `
		<hlm-tabs tab="tab01" class="w-full">
			<ng-scrollbar hlm>
				<hlm-tabs-list
					class="w-full rounded-none border-b bg-transparent px-0 py-1 group-data-horizontal/tabs:h-11"
					aria-label="tabs example">
					<button
						hlmTabsTrigger="tab01"
						class="hover:bg-accent hover:text-foreground data-[state=active]:after:bg-primary! data-[state=active]:hover:bg-accent relative border-none px-3 py-1.5 after:absolute after:inset-x-0 after:-bottom-0.5! after:-mb-1 after:h-0.5 data-[state=active]:bg-transparent data-[state=active]:shadow-none! data-[state=active]:after:opacity-100 dark:data-[state=active]:bg-transparent">
