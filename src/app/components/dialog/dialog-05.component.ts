...
@Component({
	...
	template: `
		<hlm-dialog autoFocus="dialog">
			<button id="dialog-01-button" brnDialogTrigger hlmBtn variant="outline">Scrollable (sticky header)</button>
			<hlm-dialog-content
				...
				*brnDialogContent="let ctx">
				<hlm-dialog-header class="contents space-y-0 text-left">
					<h2 class="mb-0 px-6 py-4 text-lg font-semibold">Frequently Asked Questions (FAQ)</h2>
...
export const dialog05Code = `import { Component, viewChild } from '@angular/core';
import { BrnDialogComponent, BrnDialogContentDirective, BrnDialogTriggerDirective } from '@spartan-ng/brain/dialog';
import { HlmButtonDirective } from '@spartan-ng/helm/button';
import {
	HlmDialogComponent,
