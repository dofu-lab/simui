...
@Component({
	...
	template: `
		<hlm-dialog>
			<button id="dialog-01-button" brnDialogTrigger hlmBtn variant="outline">Sign In</button>
			<hlm-dialog-content
				...
				*brnDialogContent="let ctx">
				<form [formGroup]="form" (submit)="closeDialog()">
					<div class="flex flex-col items-center gap-1">
						...
						<hlm-dialog-header>
							<h2 class="mb-0 text-center text-lg font-semibold">Log in to your account</h2>
						...
						<div class="mt-4 flex w-full flex-col gap-4">
							...
							<div class="flex items-center justify-between">
								...
								<span
									class="hover:text-primary text-muted-foreground cursor-pointer text-sm underline hover:no-underline">
									Forgot password?
								</span>
							</div>
							<button hlmBtn class="w-full" size="sm" type="submit">Sign In</button>
							<div
