...
@Component({
	...
	template: `
		<hlm-dialog autoFocus="dialog">
			<button hlmDialogTrigger hlmBtn variant="outline">Payment method</button>
			<hlm-dialog-content class="w-[calc(100vw-2rem)] gap-0 sm:max-w-[500px]" *hlmDialogPortal="let ctx">
