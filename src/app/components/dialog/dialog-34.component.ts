...
@Component({
	...
	template: `
		<hlm-dialog autoFocus="dialog">
			...
			<hlm-dialog-content
				class="top-1/2 left-1/2 flex max-h-[calc(100vh-2rem)] w-180! max-w-[calc(100%-2rem)] -translate-x-1/2 flex-col gap-0 overflow-hidden rounded-lg p-0 sm:max-h-[min(1000px,90vh)] sm:max-w-180"
					...
					<div class="mt-6 flex flex-col px-6">
						<form [formGroup]="formGroup" class="flex flex-col gap-4">
							<div class="border-t-[2px] border-dotted pt-4">
								<label hlmLabel class="text-secondary-foreground flex justify-between text-sm font-semibold">
									Name
									<div class="flex items-center gap-4">
										<input hlmInput formControlName="firstName" type="text" placeholder="First name" class="max-w-43" />
										<input hlmInput formControlName="lastName" type="text" placeholder="Last name" class="max-w-43" />
									</div>
								</label>
							</div>
							<div class="border-t-[2px] border-dotted pt-4">
								<label hlmLabel class="text-secondary-foreground flex w-full justify-between text-sm font-semibold">
									Email
									<div class="flex max-w-90 flex-1 flex-col gap-2">
										<div class="relative">
											<input
												hlmInput
												...
												class="peer mt-2 w-full ps-10 text-sm" />
											<div
							...
							<div class="border-t-[2px] border-dotted pt-4">
								<label hlmLabel for="website" class="flex flex-row justify-between">
									Website
									<div class="mt-1 flex max-w-90 flex-1 flex-row -space-x-px">
										<span
							...
							<div class="border-y-[2px] border-dotted py-4">
								<label hlmLabel for="country" class="flex w-full flex-row justify-between">
									Country
									<brn-select class="inline-block" placeholder="Select your country" formControlName="country">
										<hlm-select-trigger class="w-90">
											<hlm-select-value>
								...
								<div class="w-ful flex items-end justify-end">
									<span class="text-muted-foreground mt-1 text-sm">Estimates based on recent IP address.</span>
								</div>
							</div>
						</form>
					</div>
...
@Component({
	...
	template: \`
		<hlm-dialog autoFocus="dialog">
			<button brnDialogTrigger hlmBtn variant="outline">Edit profile (2)</button>
			<hlm-dialog-content
				class="top-1/2 left-1/2 flex max-h-[calc(100vh-2rem)] w-180! max-w-[calc(100%-2rem)] -translate-x-1/2 flex-col gap-0 overflow-hidden rounded-lg p-0 sm:max-h-[min(1000px,90vh)] sm:max-w-180"
				*brnDialogContent="let ctx">
				<div class="flex-1 overflow-y-auto">
