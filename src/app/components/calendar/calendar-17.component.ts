...
@Component({
	...
	template: `
		<div class="relative flex items-start rounded-md border">
			<div class="absolute top-0 z-10 flex w-full items-center justify-between px-2.5 pt-2.5">
...
export class Calendar17Component {
	...
	private readonly baseCalendarClass =
		'p-2 [&_button[brncalendarnextbutton]]:hidden! [&_button[brncalendarpreviousbutton]]:hidden! border-none [&_[data-outside]]:hidden';
