					...
					<div class="flex grow justify-between gap-12">
						...
						<a href="#" class="group flex items-center text-sm font-medium whitespace-nowrap">
							...
							<ng-icon
								...
								class="ms-1 -mt-0.5 inline-flex opacity-60 transition-transform duration-150 motion-reduce:transition-none [@media(hover:hover)_and_(pointer:fine)]:group-hover:translate-x-0.5" />
						</a>
					</div>
				</div>
