...
@Component({
	...
	template: `
		...
		<ng-template #menu>
			<hlm-menu class="w-50">
				<hlm-menu-group>
					<hlm-menu-label class="text-muted-foreground text-xs font-normal">Quick action</hlm-menu-label>
					<button hlmMenuItem>
				...
				<hlm-menu-separator />
				<hlm-menu-group>
					<hlm-menu-label class="text-muted-foreground text-xs font-normal">Pinned action</hlm-menu-label>
					<button hlmMenuItem>
...
export const dropdown05Code = `import { Component } from '@angular/core';
import { NgIcon, provideIcons } from '@ng-icons/core';
import {
	lucideBolt,
	lucideChevronDown,
