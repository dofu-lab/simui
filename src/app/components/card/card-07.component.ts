...
@Component({
  ...
  imports: [
    ...
    <section class="relative w-full max-w-md mx-auto">
      <div
        hlmCard
        class="relative z-0 rounded-t-2xl border-primary px-6 py-3 shadow-md bg-primary text-primary-foreground ">
        <div class="flex items-center justify-between pb-2">
          <span class="text-sm font-semibold tracking-wide uppercase">Notice Board</span>
          <span class="text-sm font-medium">2 days ago</span>
        </div>
      ...
      <div
				hlmCard
				class="relative z-10 -mt-4 rounded-2xl border-primary px-6 py-5 shadow-md">
				<p class="text-lg leading-relaxed font-medium">
					Summer camps are filling up! Sign up below for your kids this July!
				</p>
