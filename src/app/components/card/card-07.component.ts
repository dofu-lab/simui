...
@Component({
	...
	template: `
		<section class="relative mx-auto w-full max-w-md">
			<div
				hlmCard
				class="relative z-0 rounded-t-2xl border border-black bg-black px-6 py-3 text-white shadow-md [--hlm-card-padding:0]">
			...
			<div
				hlmCard
				class="relative z-10 -mt-4 rounded-2xl border border-black bg-white px-6 py-5 shadow-md [--hlm-card-padding:0]">
