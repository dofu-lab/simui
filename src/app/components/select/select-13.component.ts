...
@Component({
	...
	template: `
		<div hlmFieldGroup>
			<div
				hlmField
				class="border-input bg-background focus-within:border-ring focus-within:ring-ring/50 has-aria-invalid:border-destructive has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 ease relative gap-0 rounded-md border shadow-xs transition-[color,box-shadow] duration-150 outline-none focus-within:ring-[3px] has-[select:disabled]:cursor-not-allowed has-[select:disabled]:opacity-50 has-[select:is(:disabled)_*]:pointer-events-none motion-reduce:transition-none">
