...
@Component({
	selector: 'sim-select-07',
	imports: [HlmNativeSelectImports, HlmFieldImports],
	host: { class: 'block w-full' },
	template: `
		<div hlmFieldGroup>
			<div hlmField class="gap-2">
				<label hlmFieldLabel for="native-select-07">Select with gray background (native)</label>
				<hlm-native-select id="native-select-07" class="[&>select]:bg-muted shadow-none [&>select]:border-transparent">
...
export class Select07Component {}
