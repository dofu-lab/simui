...
@Component({
	selector: 'sim-select-02',
	imports: [HlmNativeSelectImports, HlmFieldImports],
	host: { class: 'block w-full' },
	template: `
		<div hlmFieldGroup>
			<div hlmField class="gap-2">
				<label hlmFieldLabel for="native-select-02">Select with placeholder (native)</label>
				<hlm-native-select id="native-select-02" value="placeholder">
					<option disabled hlmNativeSelectOption value="placeholder">Please select a value</option>
