...
@Component({
	...
	template: `
		<div class="flex flex-col gap-2">
			<button hlmBtn size="sm" class="bg-[#DB4437] text-white after:flex-1 hover:bg-[#DB4437]/90">
					...
					<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
						<g clip-path="url(#clip0_317_958)">
							<path
								fill-rule="evenodd"
								clip-rule="evenodd"
								d="M11.2281 4.36529C10.4021 3.57749 9.29972 3.14831 8.15917 3.16595C6.0721 3.16595 4.29955 4.57399 3.66754 6.46999V6.47003C3.33243 7.4636 3.33243 8.53947 3.66754 9.53304H3.67047C4.30541 11.4261 6.07503 12.8342 8.16211 12.8342C9.23946 12.8342 10.1644 12.5586 10.8812 12.0719V12.0699C11.7249 11.5114 12.301 10.6325 12.4803 9.63888H8.15918V6.55823H15.705C15.7991 7.09323 15.8432 7.63998 15.8432 8.1838C15.8432 10.617 14.9736 12.6742 13.4606 14.0676L13.4621 14.0688C12.1364 15.2916 10.3168 16.0001 8.15917 16.0001C5.13437 16.0001 2.36825 14.2951 1.01017 11.5937V11.5937C-0.124487 9.33315 -0.124485 6.66992 1.01018 4.4094H1.0102L1.01017 4.40938C2.36825 1.70499 5.13437 5.08294e-05 8.15917 5.08294e-05C10.1463 -0.0234656 12.0658 0.723182 13.5121 2.08126L11.2281 4.36529Z"
								fill="#D6D6D6" />
						</g>
						<defs>
							<clipPath id="clip0_317_958">
			...
			<button hlmBtn size="sm" class="bg-[#1877f2] text-white after:flex-1 hover:bg-[#1877f2]/90">
				<span class="pointer-events-none me-2 flex-1">
					<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<button hlmBtn size="sm" class="bg-[#333333] text-white after:flex-1 hover:bg-[#333333]/90">
				<span class="pointer-events-none me-2 flex-1">
					<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path
			...
			<button hlmBtn size="sm" class="bg-[#14171a] text-white after:flex-1 hover:bg-[#14171a]/90">
				<span class="pointer-events-none me-2 flex-1">
					<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path
							fill-rule="evenodd"
...
export const button48Code = `import { Component } from '@angular/core';
import { HlmButton } from '@spartan-ng/helm/button';
