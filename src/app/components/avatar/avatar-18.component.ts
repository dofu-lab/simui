...
@Component({
  ...
  template: \`
    <div class="bg-background flex rounded-full border p-1 shadow-sm">
      ...
      <div
        class="text-muted-foreground flex items-center justify-center px-1 text-xs"
      >
        Trusted by
        <span class="text-primary p-1 font-semibold">50K+</span> developers.
      </div>
    </div>
  \`,
})
