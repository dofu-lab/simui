...
@Component({
	...
	imports: [HlmAvatarComponent, HlmAvatarImageDirective, HlmAvatarFallbackDirective, HlmIconDirective, NgIcon],
	template: `
		<div class="relative">
			...
			<div
				...
				<ng-icon hlm name="lucideMinus" class="size-2 text-white" />
			</div>
		</div>
	`,
})
