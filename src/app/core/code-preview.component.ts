...
@Component({
	...
	template: `
		<div class="relative h-full min-h-0 grow overflow-auto whitespace-nowrap">
			<div class="sticky top-0 z-10 bg-[#f8f8f8] dark:bg-zinc-900">
				@if (fileName()) {
			...
			<div class="absolute min-h-0 max-w-full overflow-hidden p-4" [innerHTML]="_content"></div>
		</div>
	`,
	styles: [
		`
